                        ...
                        <ul class="au-filter__row">
                            ...
                            <li class="au-filter__col  au-filter__col_sort">
                                ...
                                <div class="au-filter__sorts" id="mse2_sort">
                                    <a href="javascript:void(0);" data-sort="new" data-dir="desc" data-default="desc" class="au-filter__label au-filter__sort sort static-dir{if $sort == 'msoption|new:desc'} active{/if}">{'stik_catalog_sort_new' | lexicon}</a>
