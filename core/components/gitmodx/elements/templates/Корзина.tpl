        ...
        <div class="au-header__head">
            <a class="au-ordering__link-back" href="" onclick="javascript:history.back(); return false;">
                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.0658 3.28239L13.3587 2.57529L5.93408 9.99992L13.3588 17.4246L14.0659 16.7175L7.34831 9.99991L14.0658 3.28239Z"
                          fill="#1A1714"></path>
                </svg>
...
{block 'scripts'}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", e => {
            var type = "ADDRESS";
            var token = "da659a5364a0d433b8a5e2641e6d7f70390f8606";
            var $country = $("input[name=country]");
            var $city = $("input[name=city]");
            var $street = $("input[name=street]");
            var $building = $("input[name=building]");
            $country.suggestions({
                token: token,
                type: type,
                constraints: {
