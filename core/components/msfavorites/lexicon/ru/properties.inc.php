...
$_lang['msfavorites_prop_uid'] = 'Идентификатор пользователя';
$_lang['msfavorites_prop_list'] = 'Произвольное имя списка избранного';
$_lang['msfavorites_prop_type'] = 'Произвольный тип списка избранного. Например: "resource" для ресурсов';
$_lang['msfavorites_prop_sortby'] = 'Сортировка выборки. Например: "&sortby=`{"createdon":"ASC"}`"';
