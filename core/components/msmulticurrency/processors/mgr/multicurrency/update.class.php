...
class MultiCurrencyUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if ($this->modx->getCount($this->classKey, array('code' => $code, 'id:!=' => $this->object->get('id')))) {
...
return 'MultiCurrencyUpdateProcessor';