...
var mSearch2 = {
    ...
    handleSelected: function (input) {
        ...
        if (count) {
            ...
            $('.mse2_total_filters').text('('+count+')');
        }
        else {
            this.selected.hide();
            $('.mse2_total_filters').text('');
        }
    },
    ...
    load: function (params, callback, append) {
        ...
        for (var i in params) {
            if (params.hasOwnProperty(i) && this.options.reset_skip.indexOf(i) === -1) {
                ...
                span = this.btn_reset.getElementById('f_counter')
            ...
            switch (elem) {
                ...
                case 'sort':
                    ...
                    $(document).find(this.options['sort_link']).each(function () {
                        item = $(this);
                        name = item.data('sort');
                        if (sorts[name] && item.attr('data-default') == sorts[name]) {
