...
class MultiCurrencySetSortProcessor extends modObjectProcessor
{
    ...
    public function initialize()
{
    ...
    /**
     * @param MultiCurrencySet $source
     * @param MultiCurrencySet $target
     */
    public function sort(MultiCurrencySet $source, MultiCurrencySet $target)
    {
...
return 'MultiCurrencySetSortProcessor';