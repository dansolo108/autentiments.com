...
$_lang['setting_msync_time_limit'] = 'Лимит выполнения';
$_lang['setting_msync_time_limit_desc'] = 'Лимит выполнения одного пакета при импорте. По умолчанию "60", выставляйте значение в соответствии с настройками хостинга.';
