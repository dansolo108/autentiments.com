            ...
            {foreach json_decode($_modx->resource.home_banner, true) as $row}
              <a href="{$row.link ?: 'javascript:;'}" class="au-home__slide  swiper-slide">
                <div class="au-home__slide-img-box">
                    {if $row.video_mob}
                      <video class="au-home__video au-home__video-mobile" webkit-playsinline playsinline autoplay loop muted poster="{$row.img_mob ?: ''}">
                    ...
                    {/if}
                    {if $row.video}
                      <video class="au-home__video au-home__video-desktop" webkit-playsinline playsinline autoplay loop muted poster="{$row.img ?: ''}">
