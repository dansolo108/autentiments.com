...
class PolylangPolylangContentSortProcessor extends modObjectProcessor
{
    ...
    public function initialize()
{
    ...
    /**
     * @param PolylangContent $source
     * @param PolylangContent $target
     */
    public function sort(PolylangContent $source, PolylangContent $target)
    {
...
return 'PolylangPolylangContentSortProcessor';